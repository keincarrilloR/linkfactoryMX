  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
      ...
      <StatusCard
        ...
        value={v?.corrFinpassMol1 ? (v.corrFinpassMol1 / 100).toFixed(2) : '0'}
      ...
      <StatusCard
        ...
        value={v?.voltThermatoolMol1?.toString() || '0'}
      ...
      <StatusCard
        ...
        value={
          v?.corrArmaduraSizingMol1
            ? (v.corrArmaduraSizingMol1 / 100).toFixed(2)
            : '0'
        }
      ...
      <StatusCard
        ...
        value={
          v?.corrArmaduraBreakdownMol1
            ? (v.corrArmaduraBreakdownMol1 / 100).toFixed(2)
            : '0'
        }
      ...
      <StatusCard
        ...
        value={v?.corrThermatoolMol1?.toString() || '0'}
      ...
      <StatusCard
        ...
        value={v?.voltPreToccoMol1?.toString() || '0'}
      ...
      <StatusCard
        ...
        value={v?.tempAguaDestEntPreToccoMol1?.toString() || '0'}
      ...
      <StatusCard
        ...
        value={Math.floor(v?.tempAguaDestEntThermatoolMol1 || 0).toString()}
      ...
      <StatusCard
        ...
        value={v?.potThermatoolMol1?.toString() || '0'}
      ...
      <StatusCard
        ...
        value={Math.ceil(v?.tempAguaDestSalPreToccoMol1 || 0).toString()}
      ...
      <StatusCard
        ...
        value={Math.ceil(v?.tempAguaDestSalThermatoolMol1 || 0).toString()}
