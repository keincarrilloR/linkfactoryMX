  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
      ...
      <StatusCard
        ...
        min={v?.velLineaMol1?.min?.toString()}
        max={v?.velLineaMol1?.max?.toString()}
        color="blue"
      >
      ...
      <StatusCard
        ...
        min={v?.corrToccoMol1?.min?.toString()}
        max={v?.corrToccoMol1?.max?.toString()}
        color="blue"
      >
      ...
      <StatusCard
        ...
        min={v?.corrFinpassMol1?.min?.toString()}
        max={v?.corrFinpassMol1?.min?.toString()}
        color="blue"
      >
        <PlugZap className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.voltThermatoolMol1?.min?.toString()}
        max={v?.voltThermatoolMol1?.max?.toString()}
        color="blue"
      >
      ...
      <StatusCard
        ...
        min={v?.corrArmaduraSizingMol1?.min?.toString()}
        max={v?.corrArmaduraSizingMol1?.max?.toString()}
        color="blue"
      >
        <PlugZap className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.corrArmaduraBreakdownMol1?.min?.toString()}
        max={v?.corrArmaduraBreakdownMol1?.max?.toString()}
        color="blue"
      >
        <PlugZap className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.corrThermatoolMol1?.min?.toString()}
        max={v?.corrThermatoolMol1?.max?.toString()}
        color="blue"
      >
        <PlugZap className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.voltPreToccoMol1?.min?.toString()}
        max={v?.voltPreToccoMol1?.max?.toString()}
        color="blue"
      >
        <PlugZap className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.tempAguaDestEntPreToccoMol1?.min?.toString()}
        max={v?.tempAguaDestEntPreToccoMol1?.max?.toString()}
        color="blue"
      >
      ...
      <StatusCard
        ...
        min={v?.tempAguaDestEntThermatoolMol1?.min?.toString()}
        max={v?.tempAguaDestEntThermatoolMol1?.max?.toString()}
        color="blue"
      >
        <Droplet className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.potThermatoolMol1?.min?.toString()}
        max={v?.potThermatoolMol1?.max?.toString()}
        color="blue"
      >
        <Zap className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.tempAguaDestSalPreToccoMol1?.min?.toString()}
        max={v?.tempAguaDestSalPreToccoMol1?.max?.toString()}
        color="blue"
      >
        <Droplet className={classesIcons} />
      </StatusCard>
      ...
      <StatusCard
        ...
        min={v?.tempAguaDestSalThermatoolMol1?.min?.toString()}
        max={v?.tempAguaDestSalThermatoolMol1?.max?.toString()}
        color="blue"
      >
        <Droplet className={classesIcons} />
      </StatusCard>
